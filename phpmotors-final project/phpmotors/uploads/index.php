...
switch ($action) {
    case 'upload':
        ...
        if($imageCheck){
            $message = '<p class="form-msg">An image by that name already exists.</p>';
        } elseif (empty($invId) || empty($imgName)) {
            $message = '<p class="form-msg">You must select a vehicle and image file for the vehicle.</p>';
        } else {
            ...
            if ($result) {
                $message = '<p class="form-msg">The upload succeeded.</p>';
            } else {
                $message = '<p class="form-msg">Sorry, the upload failed.</p>';
            }
        }
    ...
    case 'delete':
        ...
        if ($remove) {
            $message = "<p class='form-msg'>$filename was successfully deleted.</p>";
        } else {
            $message = "<p class='form-msg'>$filename was NOT deleted.</p>";
        }
    ...
    default:
        ...
        if (count($imageArray)) {
            ...
            $imageDisplay = '<p class="form-msg">Sorry, no images could be found.</p>';
        }
